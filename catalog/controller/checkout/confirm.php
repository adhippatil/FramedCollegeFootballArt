...
class ControllerCheckoutConfirm extends Controller { 
	...
	public function index() {
  	...
  	private function validateCoupon() {
		...
		if(isset($this->session->data['gift_voucher'])){
			$this->error['warning'] = "Groupons, Vouchers, and Coupons may not be combined. Please use only one.";
		} else {		
	...
	private function validateGiftVoucher() {
		...
		if(isset($this->session->data['coupon'])){
			$this->error['warning'] = "Groupons, Vouchers, and Coupons may not be combined. Please use only one.";
		} elseif(!isset($this->session->data['gift_voucher'])){
			...
			$this->error['warning'] = "Voucher has already been applied! Limit One Voucher Per Order";
