...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['productimportexport'] = HTTPS_SERVER . 'index.php?route=catalog/productimportexport&token=' . $this->session->data['token'];
			...
			$this->data['zone'] = HTTPS_SERVER . 'index.php?route=localisation/zone&token=' . $this->session->data['token'];
      		$this->data['footer'] = HTTPS_SERVER . 'index.php?route=catalog/footer_links&token=' . $this->session->data['token'];
		}
