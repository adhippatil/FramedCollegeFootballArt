<?php    
class Controllercatalogfooterlinks extends Controller { 
	private $error = array();
	...
	public function update(){
  	...
  	private function getList() {
		...
		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => HTTPS_SERVER . 'index.php?route=catalog/footer_links&token=' . $this->session->data['token'],
       		'text'      => $this->language->get('heading_title'),
      		'separator' => ' :: '
   		);
		
		$this->data['insert'] = HTTPS_SERVER . 'index.php?route=catalog/footer_links/insert&token=' . $this->session->data['token'];
		$this->data['edit'] = HTTPS_SERVER . 'index.php?route=catalog/footer_links/edit&token=' . $this->session->data['token'];
		$this->data['update'] = HTTPS_SERVER . 'index.php?route=catalog/footer_links/update&token=' . $this->session->data['token'];
