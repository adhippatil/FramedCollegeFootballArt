...
function getProducts() {
	...
	$.ajax({
		url: 'index.php?route=catalog/productimportexport/category&token=<?php echo $token; ?>&category_id=' + $('#category').attr('value'),
		dataType: 'json',
...
function getRelated() {
	...
	$.ajax({
		url: 'index.php?route=catalog/productproductimportexport/related&token=<?php echo $token; ?>',
		type: 'POST',
		dataType: 'json',
