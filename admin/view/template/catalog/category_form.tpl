      ...
      <div id="tab_general">
        ...
        <div id="language<?php echo $language['language_id']; ?>">
          <table class="form">
            ...
            <tr>
              <td>Menu Text</td>
              <td><input name="category_description[<?php echo $language['language_id']; ?>][menu_text]" size="100" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['menu_text'] : ''; ?>" />
                <?php if (isset($error_name[$language['language_id']])) { ?>
                <span class="error"><?php echo $error_name[$language['language_id']]; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              ...
              <td><input name="page_title" size="100" value="<?=$page_title?>" />
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><textarea name="category_description[<?php echo $language['language_id']; ?>][description_more]" id="description_more<?php echo $language['language_id']; ?>"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['description_more'] : ''; ?></textarea></td>
            </tr>
          </table>
        </div>
		<?php } ?>
...
CKEDITOR.replace('description_more<?php echo $language['language_id']; ?>', {
  filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
  filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
