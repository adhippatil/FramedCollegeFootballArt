  ...
  <div id="tab_general" class="page">
    <table class="form">
	  ...
	  <tr>
	    ...
	    <td>
	      <input type="radio" name="fedex_debug" value="1"<?php echo ($fedex_debug)?' checked="checked"':''?> />
  	      <?php echo $text_yes; ?>
	      <input type="radio" name="fedex_debug" value="0"<?php echo (!$fedex_debug)?' checked="checked"':''?> />
	      <?php echo $text_no; ?>
	  </tr>
      <tr>
	  ...
	  <tr>
        ...
        <td><select name="fedex_country_id" id="country" onchange="$('#zone').load('index.php?token=<?php echo $this->session->data['token']; ?>&route=shipping/fedex/zone&country_id=' + this.value + '&zone_id=<?php echo $fedex_zone_id; ?>');">
      ...
      <tr>
        ...
        <td><input type="text" name="fedex_city" value="<?php echo $fedex_city; ?>" /></td>
      </tr>
      <tr>
      ...
      <tr>
	    ...
	    <td>
	      <input type="radio" name="fedex_list" value="1"<?php echo ($fedex_list)?' checked="checked"':''?> />
  	      <?php echo $text_yes; ?>
	      <input type="radio" name="fedex_list" value="0"<?php echo (!$fedex_list)?' checked="checked"':''?> />
	      <?php echo $text_no; ?>
	      <br/><span class="help"><?php echo $help_list; ?></span>
	  </tr>
      <tr>
	  ...
	  <tr>
        ...
        <td><input type="text" name="fedex_box_weight" value="<?php echo $fedex_box_weight; ?>" /></td>
      </tr>
      <tr>
...
//$('#zone').load('index.php?token=<?php echo $this->session->data['token']; ?>&route=setting/setting/zone&country_id=' + $('#country').attr('value') + '&zone_id=<?php echo $fedex_zone_id; ?>');
$('#zone').load('index.php?token=<?php echo $this->session->data['token']; ?>&route=shipping/fedex/zone&country_id=' + $('#country').attr('value') + '&zone_id=<?php echo $fedex_zone_id; ?>');
